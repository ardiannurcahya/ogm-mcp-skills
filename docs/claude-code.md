...
Copy `examples/claude-code/CLAUDE.md.example` into your project root `CLAUDE.md` to instruct Claude Code to recall memory before diagnosing bugs and record verified solutions upon resolution.
